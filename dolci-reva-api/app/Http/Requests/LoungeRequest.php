...
class LoungeRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        ...
        if ($age === '' || $age === null || $age === 'null' || $age === 'NaN') {
            $this->merge(['age_restriction' => null]);
        }
        ...
        if (is_array($venueType)) {
            $this->merge(['venue_type' => $venueType[0] ?? 'LOUNGE']);
        }
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'venue_type' => 'nullable|string|in:LOUNGE,BAR,NIGHT_CLUB',
    ...
    private function normalizeTime(mixed $value): ?string
    {
        ...
        // HTML time inputs may send H:i:s — Laravel rule expects H:i

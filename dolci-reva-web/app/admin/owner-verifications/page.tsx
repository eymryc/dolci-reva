...
export default function OwnerVerificationsPage() {
  ...
  const handleApproveOwner = (verificationId: number, data: ApproveOwnerData) => {
  ...
  const handleRejectOwner = (verificationId: number, data: RejectOwnerData) => {
  ...
  const handleSuspendOwner = (verificationId: number, data: SuspendOwnerData) => {

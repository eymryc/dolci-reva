...
class LoungeBookingRequest extends FormRequest
{
    ...
    protected function prepareForValidation(): void
    {
        if ($this->filled('start_date')) {
            $normalized = HospitalitySlot::apply($this->all(), 'lounge');
    ...
    public function rules(): array
    {
        return [
            ...
            'lounge_table_ids' => 'required|array|min:1',
    ...
    public function messages(): array
    {
        return [
            ...
            'lounge_table_ids.required' => 'Veuillez sélectionner au moins une table.',
            'lounge_table_ids.min' => 'Veuillez sélectionner au moins une table.',

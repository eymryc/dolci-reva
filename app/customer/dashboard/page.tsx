...
export default function CustomerDashboardPage() {
  ...
  const stats = useMemo(() => {
    ...
    // Réservations de résidences (bookable_type contient "Residence")
                ...
                <TabsContent value="hebergement" className="mt-0">
                  <div className="py-16">
                    <div className="text-center">
                      ...
                      <h3 className="text-xl font-semibold text-gray-900 mb-2">Hébergement</h3>

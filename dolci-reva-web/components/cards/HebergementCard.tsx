...
const HebergementCard: React.FC<HebergementCardProps> = ({
  ...
  return (
    <Link href={linkHref} className="block group/card">
      <div className="bg-white rounded-none sm:rounded-none shadow-md overflow-hidden flex flex-col sm:flex-row min-h-[280px] h-auto group transition-all duration-300 hover:shadow-2xl hover:-translate-y-1 border border-gray-100 cursor-pointer">
      ...
      <div className="relative w-full sm:w-2/5 h-48 sm:h-auto sm:min-w-[280px] sm:min-h-[280px] overflow-hidden">
          ...
          <div className="absolute bottom-2 sm:bottom-3 left-1/2 -translate-x-1/2 flex gap-1 sm:gap-1.5 z-10">
            {allImages.map((_, index) => (
              <button
                ...
                className={`w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-none transition-all duration-200 ${
        ...
        <button
          ...
          className="absolute bottom-2 right-2 sm:bottom-3 sm:right-3 z-10 w-7 h-7 sm:w-8 sm:h-8 rounded-none bg-white/90 backdrop-blur-sm flex items-center justify-center shadow-lg hover:bg-white transition-colors duration-200 group/zoom"
      ...
      <div className="flex-1 flex flex-col relative sm:min-h-[280px]">
        ...
        <div className="p-4 sm:p-6 pb-3 sm:pb-4 relative">
          ...
          <div className="flex items-start justify-between mb-2 sm:mb-3 gap-2">
            ...
            <button
              ...
              className="flex items-center gap-1 sm:gap-1.5 px-2 sm:px-3 py-1 sm:py-1.5 text-xs sm:text-sm font-semibold text-theme-primary hover:text-theme-primary/80 hover:bg-theme-primary/10 rounded-none transition-all duration-200 flex-shrink-0"
            >
          ...
          <div className="flex flex-wrap items-center gap-1.5 sm:gap-2 mb-2 sm:mb-3">
            {type && (
              <span className="px-2 sm:px-2.5 py-0.5 sm:py-1 bg-theme-primary/10 text-theme-primary rounded-none font-semibold border border-theme-primary/20 text-[10px] sm:text-xs">
                {formatLabel(type)}
              </span>
            )}
            {(structureTypeLabel || structureType) && (
              <span className="px-2 sm:px-2.5 py-0.5 sm:py-1 bg-blue-50 text-blue-700 rounded-none font-medium border border-blue-200 text-[10px] sm:text-xs">
                {structureTypeLabel || formatLabel(structureType || '')}
              </span>
            )}
            {(constructionTypeLabel || constructionType) && (
              <span className="px-2 sm:px-2.5 py-0.5 sm:py-1 bg-purple-50 text-purple-700 rounded-none font-medium border border-purple-200 text-[10px] sm:text-xs">
                ...
                return (
                  ...
                  >
                    {Icon ? (
                      ...
                      <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-none bg-gray-400" />
                    )}
                  </div>
                );
              })}
          ...
          {(rentAdvanceAmountNumber || securityDepositMonthNumber || agencyFeesMonthNumber || visitePrice) && (
            <div className="flex flex-wrap items-center gap-2 sm:gap-2.5">
              {rentAdvanceAmountNumber && rentAdvanceAmountNumber > 0 && (
                <div className="flex items-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-1.5 sm:py-2 bg-gradient-to-r from-blue-50 to-blue-100/50 rounded-none border border-blue-200/60 shadow-sm hover:shadow-md transition-shadow">
                  <div className="flex items-center justify-center w-6 h-6 sm:w-7 sm:h-7 rounded-none bg-blue-500/10">
              ...
              {securityDepositMonthNumber && securityDepositMonthNumber > 0 && (
                <div className="flex items-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-1.5 sm:py-2 bg-gradient-to-r from-amber-50 to-amber-100/50 rounded-none border border-amber-200/60 shadow-sm hover:shadow-md transition-shadow">
                  <div className="flex items-center justify-center w-6 h-6 sm:w-7 sm:h-7 rounded-none bg-amber-500/10">
              ...
              {agencyFeesMonthNumber && agencyFeesMonthNumber > 0 && (
                <div className="flex items-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-1.5 sm:py-2 bg-gradient-to-r from-purple-50 to-purple-100/50 rounded-none border border-purple-200/60 shadow-sm hover:shadow-md transition-shadow">
                  <div className="flex items-center justify-center w-6 h-6 sm:w-7 sm:h-7 rounded-none bg-purple-500/10">
              ...
              {visitePrice && visitePrice > 0 && (
                <div className="flex items-center gap-1.5 sm:gap-2 px-2 sm:px-3 py-1.5 sm:py-2 bg-gradient-to-r from-green-50 to-green-100/50 rounded-none border border-green-200/60 shadow-sm hover:shadow-md transition-shadow">
                  <div className="flex items-center justify-center w-6 h-6 sm:w-7 sm:h-7 rounded-none bg-green-500/10">
        ...
        <div className="mt-auto flex flex-col sm:flex-row items-start sm:items-end justify-between gap-3 sm:gap-4 pt-3 sm:pt-4 px-4 sm:px-6 pb-4 sm:pb-6 bg-theme-primary">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 flex-wrap">
            {pieceNumber != null && (
              <div className="flex items-center gap-1 sm:gap-1.5 px-2 sm:px-3 py-1 sm:py-1.5 bg-white/20 backdrop-blur-sm rounded-none border border-white/30">

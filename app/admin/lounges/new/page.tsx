...
import { useCreateNightlifeVenue, type NightlifeVenueFormData } from "@/hooks/use-nightlife-venues";
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          <div>
            ...
            <p className="text-gray-600 text-xs sm:text-sm font-medium">
              Remplissez les informations ci-dessous pour créer mon espace
            </p>
          </div>
        </div>
        <Button

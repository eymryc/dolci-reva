...
const residenceSchema = z.object({
  ...
  feature_option_ids: z.array(z.number().int()).min(1, "Au moins un équipement est requis").max(20, "Vous ne pouvez pas sélectionner plus de 20 équipements"),
});
...
export function ResidenceForm({
  ...
  // Address autocomplete - skip query when address already selected (edit mode)
